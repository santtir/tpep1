...
<div class="container">
        ...
        {foreach from=$teams item=$team }
            ...
            <form method="POST" action="coment">
                ...
                <div class="form-floating">
                    <textarea name="comentario" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
    ...
    {else}
        ...
        <form action="equipmentDetail" method="POST" class="my-4">
            ...
            <button id="btn-comentar" type="submit" class="btn btn-dark mt-2" href='sendTeam'>Enviar</button>
        </form>
